...
; Example usage:
	...
	; wev := new WinEventsWatcher({(WinEventsWatcher.EVENT_OBJECT_DESTROY) : ["onWinDestroy"]
	;                            , (WinEventsWatcher.EVENT_OBJECT_CREATE)  : ["onWinCreated"]  })
...
;public:
	...
	;{ Event Constants (https://docs.microsoft.com/en-us/windows/win32/winauto/event-constants)
